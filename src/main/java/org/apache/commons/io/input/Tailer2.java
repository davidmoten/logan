 ...
 * <p>For example:</p>
 * <pre>
 *  public class MyTailerListener2 extends TailerListener2Adapter {
 ...
 */
public class Tailer2 implements Runnable {
     ...
     */
    public Tailer2(final File file, final TailerListener2 listener) {
     ...
     */
    public Tailer2(final File file, final TailerListener2 listener, final long delayMillis) {
     ...
     */
    public Tailer2(final File file, final TailerListener2 listener, final long delayMillis, final boolean end) {
     ...
     * @param bufSize Buffer size
     */
    public Tailer2(final File file, final Charset cset, final TailerListener2 listener, final long delayMillis,
     ...
     */
    public static Tailer2 create(final File file, final TailerListener2 listener, final long delayMillis,
     ...
     * @return The new tailer
     */
    public static Tailer2 create(final File file, final Charset charset, final TailerListener2 listener,
                                final long delayMillis, final boolean end, final boolean reOpen
            ,final int bufSize) {
        final Tailer2 tailer = new Tailer2(file, charset, listener, delayMillis, end, reOpen, bufSize);
     ...
     * @return The new tailer
     */
    public static Tailer2 create(final File file, final TailerListener2 listener) {
    ...
    private long readLines(final RandomAccessFile reader) throws IOException {
        ...
        if (listener instanceof TailerListenerAdapter2) {
            ((TailerListenerAdapter2) listener).endOfFileReached();
        }
