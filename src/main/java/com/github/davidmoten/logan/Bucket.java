...
public class Bucket {
     ...
     * 
     * @param timestamp
     *            timestamp bucket to add to
     * @param value
     *            value to increase bucket by
     */
     ...
     * 
     * @return the first value reported to the bucket
     */
    public Double first() {
        return first;
    }
     ...
     * 
     * @return sum of squares of the values reported to the bucket
     */
     ...
     * 
     * @return returns the mean of the values reported to the bucket.
     */
    public Double mean() {
        if (count == 0)
            return null;
     ...
     * 
     * @return standard deviation of the values in the bucket
     */
     ...
     * 
     * @return last value reported to the bucket
     */
    public Double last() {
        return last;
    }
     ...
     * 
     * @return earliest value by timestamp
     */
     ...
     * @param metric
     *            metric to return
     * @return value for the bucket according to the metric
     */
    ...
    /**
     * Returns the start of the bucket (x-coordinate min).
     * 
     * @return start of the bucket
     */
